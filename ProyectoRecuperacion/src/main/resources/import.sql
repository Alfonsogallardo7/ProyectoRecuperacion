...
insert into usuario (id, nombre, apellidos, direccion, email, telefono, avatar, password, role) values (uuid(), 'Alfonso', 'admin', 'Conde de Bustillo 17', 'alfonso@openwebinars.net', 697854123, 'foto.png', '$2a$12$cNocjmlKpOA/iMQZAq5bAeV/zrTepR1xr2pKi6lIRBEiAqrV2/6Ya', 'ADMIN');
